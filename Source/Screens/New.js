...
function New({ navigation}) {
  return (
    <Container>
       ...
       <Image source={require('../Assests/Silvercoin.png')} style={{alignSelf:'center',marginTop:'21%',shadowColor:'grey'}} />

       <View >
       <Card  style={{ borderRadius:15,flexDirection:'row',justifyContent:'space-between',width:'83%',alignSelf:'center',paddingHorizontal:15,paddingVertical:12,elevation:10}}>
